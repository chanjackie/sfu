...
def main():
    ...
    bayes_convert_model = make_pipeline(transformer, GaussianNB())

    knn_rgb_model = KNeighborsClassifier(n_neighbors=15, weights='distance')
    knn_convert_model = make_pipeline(transformer, KNeighborsClassifier(n_neighbors=15, weights='distance'))

    rf_rgb_model = RandomForestClassifier(n_estimators=100, max_depth=15, criterion='entropy')
    rf_convert_model = make_pipeline(transformer, RandomForestClassifier(n_estimators=100, max_depth=15, criterion='entropy'))
