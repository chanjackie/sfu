...
class DenseLayer(BaseLayer):
    ...
    def compute_activation(self, x):
        ...
        output =  np.dot(self._input_data,self.w)
    ...
    def compute_gradient(self):
        ...
        self.dw = np.transpose(np.dot(np.transpose(self._output_error_gradient), self._input_data))

        self.db = np.dot(np.ones((1,self._output_error_gradient.shape[0])),self._output_error_gradient)
    ...
    def update_weights(self, learning_rate):
        ...
        # act = self.compute_activation(self._input_data)
        # self._output_error_gradient = -act
        # self.compute_gradient()
        #print(self.dw - learning_rate*self.dw)
