  ...
  */
    ...
    if(roid->x-roid->width/2.0 < 0){
        draw_rectangle( 1+roid->x-roid->width/2.0, roid->y-roid->height/2.0,
                       1, roid->y+roid->height/2,roid->color );
    }
    if(roid->y-roid->height/2.0 < 0){
        draw_rectangle( roid->x-roid->width/2.0, 1+roid->y-roid->height/2.0,
                       roid->x+roid->width/2.0, 1,roid->color );
    }
    if(roid->x+roid->width/2.0 > 1){
        draw_rectangle( 0, roid->y-roid->height/2.0,
                       roid->x+roid->width/2.0-1, roid->y+roid->height/2,roid->color );
    }
    if(roid->y+roid->height/2.0 > 1){
        draw_rectangle( roid->x-roid->width/2.0, 0,roid->x+roid->width/2.0, roid->y+roid->height/2-1,
                       roid->color );
    }
}
...
/* Returns non-zero (true) if the shot is located in the rectangle
   ...
   int shot_roid_hit( const shot_t* shot, const roid_t* roid )
   {
       if(roid->x - roid->width/2 < 0){
           if(( shot->x >= roid->x - roid->width/2 && shot->x <= roid->x + roid->width/2 &&
               shot->y >= roid->y - roid->height/2 && shot->y <= roid->y + roid->height/2 ) || (
               shot->x-1 >= roid->x - roid->width/2 && shot->x-1 <= roid->x + roid->width/2 &&
               shot->y >= roid->y - roid->height/2 && shot->y <= roid->y + roid->height/2 ))
               return 1;
       }
       if(roid->y - roid->height/2 < 0){
           if (( shot->x >= roid->x - roid->width/2 && shot->x <= roid->x + roid->width/2 &&
                shot->y >= roid->y - roid->height/2 && shot->y <= roid->y + roid->height/2 ) ||
                 ( shot->x >= roid->x - roid->width/2 && shot->x <= roid->x + roid->width/2 &&
                    shot->y-1 >= roid->y - roid->height/2 && shot->y-1 <= roid->y + roid->height/2 ))
               return 1;
       }
       ...
       return( shot->x >= roid->x - roid->width/2 && shot->x <= roid->x + roid->width/2 &&
              shot->y >= roid->y - roid->height/2 && shot->y <= roid->y + roid->height/2 );
